 ...
 * taken from https://github.com/gtownsend/icon/blob/master/src/common/munix.c
 */
...
/* PATH_MAX snippet from random.c
 */
...
#ifdef NEED_ICON_RELFILE

#ifndef NEED_ICON_FINDEXE
#define NEED_ICON_FINDEXE
#endif

#ifndef NEED_ICON_FINDONPATH
#define NEED_ICON_FINDONPATH
#endif

#ifndef NEED_ICON_FOLLOWSYM
#define NEED_ICON_FOLLOWSYM
#endif

#ifndef NEED_ICON_CANONIZE
#define NEED_ICON_CANONIZE
#endif
...
char *
findexe(char *name, char *buf, size_t len)
{
	int n;
	char *s;
 ...
 */
char *
findonpath(char *name, char *buf, size_t len)
{
	int nlen, plen;
...
char *
followsym(char *name, char *buf, size_t len)
{
	int i, n;
	char *s, tbuf[MaxPath];
	strcpy(buf, name);
